        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                override fun onError(exc: ImageCaptureException) {
                    Toast.makeText(activity, getString(R.string.take_photo_failed), Toast.LENGTH_SHORT).show()
                }
                ...
                override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                    ...
                    view?.findNavController()?.navigate(R.id.action_cameraFragment_to_addStoryFragment)
                }
            }
        )
    }
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            try {
                ...
                Toast.makeText(activity, getString(R.string.unable_show_camera), Toast.LENGTH_SHORT).show()
            }
        }, ContextCompat.getMainExecutor(requireActivity()))
    }
